...
# suggestions = find_restaurants(location, cuisine, budget)

# for suggestion in suggestions:
#     print(f"Name: {suggestion['name']}")
#     print(f"Address: {suggestion['address']}")
#     print(f"positive_reviews :{suggestion['positive_reviews']}")
#     print(f"negative_reviews :{suggestion['negative_reviews']}")
#     print(f"Must try : {suggestion['must_try_items']}")
#     print(f"Disliked Items: {suggestion['disliked_items']}")
#     print(f"Ambience: {suggestion['ambience']}")
